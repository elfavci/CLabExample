...
int depthFsearch(char **arr, bool **visit, int x, int y, int a, int b) {
    ...
    // Check 8 neighbors
    count += depthFsearch(arr, visit, x - 1, y - 1, a, b); // up left
    count += depthFsearch(arr, visit, x - 1, y, a, b); // up
    count += depthFsearch(arr, visit, x - 1, y + 1, a, b); // up right
    count += depthFsearch(arr, visit, x, y - 1, a, b); // left
    count += depthFsearch(arr, visit, x, y + 1, a, b); // right
    count += depthFsearch(arr, visit, x + 1, y - 1, a, b); // down left
    count += depthFsearch(arr, visit, x + 1, y, a, b); // down
    count += depthFsearch(arr, visit, x + 1, y + 1, a, b); // down right
